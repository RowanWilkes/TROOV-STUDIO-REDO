  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-white via-gray-50 to-white flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 right-20 size-[500px] bg-[#2DCE73]/20 rounded-full blur-3xl" />
        <div className="absolute bottom-20 left-20 size-[400px] bg-[#2DCE73]/15 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md space-y-6 relative z-10">
        ...
        <Card className="p-8 space-y-6 border-[#2DCE73]/30 shadow-[0_0_50px_rgba(45,206,115,0.25)]">
          <div className="space-y-2 text-center">
            <h1 className="text-3xl font-bold text-[#013B34]">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-sm text-[#2DCE73] hover:text-[#013B34] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-gray-600">
            ...
            <Link href="/signup" className="text-[#2DCE73] font-medium hover:text-[#013B34] transition-colors">
              Sign up
            </Link>
          </p>
        </Card>
